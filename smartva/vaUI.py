...
COUNTRIES = [COUNTRY_DEFAULT, u'Afghanistan (AFG)', u'Åland Islands (ALA)', u'Albania (ALB)', u'Algeria (DZA)',
             u'American Samoa (ASM)', u'Andorra (AND)', u'Angola (AGO)', u'Anguilla (AIA)', u'Antarctica (ATA)',
             u'Antigua and Barbuda (ATG)', u'Argentina (ARG)', u'Armenia (ARM)', u'Aruba (ABW)', u'Australia (AUS)',
             u'Austria (AUT)', u'Azerbaijan (AZE)', u'Bahamas (BHS)', u'Bahrain (BHR)', u'Bangladesh (BGD)',
             u'Barbados (BRB)', u'Belarus (BLR)', u'Belgium (BEL)', u'Belize (BLZ)', u'Benin (BEN)', u'Bermuda (BMU)',
             u'Bhutan (BTN)', u'Bolivia, Plurinational State of (BOL)', u'Bosnia and Herzegovina (BIH)',
             u'Botswana (BWA)', u'Bouvet Island (BVT)', u'Brazil (BRA)', u'British Indian Ocean Territory (IOT)',
             u'Brunei Darussalam (BRN)', u'Bulgaria (BGR)', u'Burkina Faso (BFA)', u'Burundi (BDI)', u'Cambodia (KHM)',
             u'Cameroon (CMR)', u'Canada (CAN)', u'Cape Verde (CPV)', u'Cayman Islands (CYM)',
             u'Central African Republic (CAF)', u'Chad (TCD)', u'Chile (CHL)', u'China (CHN)',
             u'Christmas Island (CXR)', u'Cocos (Keeling) Islands (CCK)', u'Colombia (COL)', u'Comoros (COM)',
             u'Congo (COG)', u'Congo, the Democratic Republic of the (COD)', u'Cook Islands (COK)', u'Costa Rica (CRI)',
             u'Côte d\'Ivoire (CIV)', u'Croatia (HRV)', u'Cuba (CUB)', u'Cyprus (CYP)', u'Czech Republic (CZE)',
             u'Denmark (DNK)', u'Djibouti (DJI)', u'Dominica (DMA)', u'Dominican Republic (DOM)', u'Ecuador (ECU)',
             u'Egypt (EGY)', u'El Salvador (SLV)', u'Equatorial Guinea (GNQ)', u'Eritrea (ERI)', u'Estonia (EST)',
             u'Ethiopia (ETH)', u'Falkland Islands (Malvinas) (FLK)', u'Faroe Islands (FRO)', u'Fiji (FJI)',
             u'Finland (FIN)', u'France (FRA)', u'French Guiana (GUF)', u'French Polynesia (PYF)',
             u'French Southern Territories (ATF)', u'Gabon (GAB)', u'Gambia (GMB)', u'Georgia (GEO)', u'Germany (DEU)',
             u'Ghana (GHA)', u'Gibraltar (GIB)', u'Greece (GRC)', u'Greenland (GRL)', u'Grenada (GRD)',
             u'Guadeloupe (GLP)', u'Guam (GUM)', u'Guatemala (GTM)', u'Guernsey (GGY)', u'Guinea (GIN)',
             u'Guinea-Bissau (GNB)', u'Guyana (GUY)', u'Haiti (HTI)', u'Heard Island and McDonald Islands (HMD)',
             u'Holy See (Vatican City State) (VAT)', u'Honduras (HND)', u'Hong Kong (HKG)', u'Hungary (HUN)',
             u'Iceland (ISL)', u'India (IND)', u'Indonesia (IDN)', u'Iran, Islamic Republic of (IRN)', u'Iraq (IRQ)',
             u'Ireland (IRL)', u'Isle of Man (IMN)', u'Israel (ISR)', u'Italy (ITA)', u'Jamaica (JAM)', u'Japan (JPN)',
             u'Jersey (JEY)', u'Jordan (JOR)', u'Kazakhstan (KAZ)', u'Kenya (KEN)', u'Kiribati (KIR)',
             u'Korea, Democratic People\'s Republic of (PRK)', u'Korea, Republic of (KOR)', u'Kuwait (KWT)',
             u'Kyrgyzstan (KGZ)', u'Lao People\'s Democratic Republic (LAO)', u'Latvia (LVA)', u'Lebanon (LBN)',
             u'Lesotho (LSO)', u'Liberia (LBR)', u'Libyan Arab Jamahiriya (LBY)', u'Liechtenstein (LIE)',
             u'Lithuania (LTU)', u'Luxembourg (LUX)', u'Macao (MAC)',
             u'Macedonia, the former Yugoslav Republic of (MKD)', u'Madagascar (MDG)', u'Malawi (MWI)',
             u'Malaysia (MYS)', u'Maldives (MDV)', u'Mali (MLI)', u'Malta (MLT)', u'Marshall Islands (MHL)',
             u'Martinique (MTQ)', u'Mauritania (MRT)', u'Mauritius (MUS)', u'Mayotte (MYT)', u'Mexico (MEX)',
             u'Micronesia, Federated States of (FSM)', u'Moldova, Republic of (MDA)', u'Monaco (MCO)',
             u'Mongolia (MNG)', u'Montenegro (MNE)', u'Montserrat (MSR)', u'Morocco (MAR)', u'Mozambique (MOZ)',
             u'Myanmar (MMR)', u'Namibia (NAM)', u'Nauru (NRU)', u'Nepal (NPL)', u'Netherlands (NLD)',
             u'Netherlands Antilles (ANT)', u'New Caledonia (NCL)', u'New Zealand (NZL)', u'Nicaragua (NIC)',
             u'Niger (NER)', u'Nigeria (NGA)', u'Niue (NIU)', u'Norfolk Island (NFK)',
             u'Northern Mariana Islands (MNP)', u'Norway (NOR)', u'Oman (OMN)', u'Pakistan (PAK)', u'Palau (PLW)',
             u'Palestinian Territory, Occupied (PSE)', u'Panama (PAN)', u'Papua New Guinea (PNG)', u'Paraguay (PRY)',
             u'Peru (PER)', u'Philippines (PHL)', u'Pitcairn (PCN)', u'Poland (POL)', u'Portugal (PRT)',
             u'Puerto Rico (PRI)', u'Qatar (QAT)', u'Réunion (REU)', u'Romania (ROU)', u'Russian Federation (RUS)',
             u'Rwanda (RWA)', u'Saint Barthélemy (BLM)', u'Saint Helena, Ascension and Tristan da Cunha (SHN)',
             u'Saint Kitts and Nevis (KNA)', u'Saint Lucia (LCA)', u'Saint Martin (French part) (MAF)',
             u'Saint Pierre and Miquelon (SPM)', u'Saint Vincent and the Grenadines (VCT)', u'Samoa (WSM)',
             u'San Marino (SMR)', u'Sao Tome and Principe (STP)', u'Saudi Arabia (SAU)', u'Senegal (SEN)',
             u'Serbia (SRB)', u'Seychelles (SYC)', u'Sierra Leone (SLE)', u'Singapore (SGP)', u'Slovakia (SVK)',
             u'Slovenia (SVN)', u'Solomon Islands (SLB)', u'Somalia (SOM)', u'South Africa (ZAF)',
             u'South Georgia and the South Sandwich Islands (SGS)', u'Spain (ESP)', u'Sri Lanka (LKA)', u'Sudan (SDN)',
             u'Suriname (SUR)', u'Svalbard and Jan Mayen (SJM)', u'Swaziland (SWZ)', u'Sweden (SWE)',
             u'Switzerland (CHE)', u'Syrian Arab Republic (SYR)', u'Taiwan, Province of China (TWN)',
             u'Tajikistan (TJK)', u'Tanzania, United Republic of (TZA)', u'Thailand (THA)', u'Timor-Leste (TLS)',
             u'Togo (TGO)', u'Tokelau (TKL)', u'Tonga (TON)', u'Trinidad and Tobago (TTO)', u'Tunisia (TUN)',
             u'Turkey (TUR)', u'Turkmenistan (TKM)', u'Turks and Caicos Islands (TCA)', u'Tuvalu (TUV)',
             u'Uganda (UGA)', u'Ukraine (UKR)', u'United Arab Emirates (ARE)', u'United Kingdom (GBR)',
             u'United States (USA)', u'United States Minor Outlying Islands (UMI)', u'Uruguay (URY)',
             u'Uzbekistan (UZB)', u'Vanuatu (VUT)', u'Venezuela, Bolivarian Republic of (VEN)', u'Viet Nam (VNM)',
             u'Virgin Islands, British (VGB)', u'Virgin Islands, U.S. (VIR)', u'Wallis and Futuna (WLF)',
             u'Western Sahara (ESH)', u'Yemen (YEM)', u'Zambia (ZMB)', u'Zimbabwe (ZWE)']
