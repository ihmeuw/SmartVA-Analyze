...
from smartva.neonate_tariff_data import (
    HCE_DROP_LIST,
...
class NeonateTariff(TariffPrep):
    ...
    def run(self):
        ...
        cutoffs = self.generate_cutoffs(uniform_list, 0.91)
        ...
        self.identify_lowest_ranked_causes(va_cause_list, uniform_list, cutoffs, CAUSE_CONDITIONS, lowest_rank, 0.35, 1.0)
