...
class NeonatePreSymptomPrep(object):
    ...
    def run(self):
        ...
        if self.shortform:
            ...
            neonate_defaultFill = default_fill_data.NEONATE_DEFAULT_FILL
        ...
        error = 0
        status_logger.debug('Neonate :: Verifying answers fall within legal bounds')
        ...
        for row in matrix:
            ...
            if (row[headers.index('c1_25b')] != '' and int(row[headers.index('c1_25b')]) >= 1 and int(
                ...
                # removed, as in child, per abie's email
            ...
            row[headers.index('c1_08num')] = float(child_1_8a) + float(child_1_8b)
        ...
        for i, row in enumerate(matrix):
            ...
            if c1_15 == '1' or c1_26 == '2' or c3_04 == '0':
                ...
                if not (c3_05 is None or c3_05 == ''):
                    self.printWarning('c3_05', i, row, headers, neonate_defaultFill)
            c3_07 = row[headers.index('c3_07')]
            if c1_15 == '1' or c1_26 == '2' or c3_07 == '1':
                c3_08 = row[headers.index('c3_08')]
                if not (c3_08 is None or c3_08 == ''):
                    self.printWarning('c3_08', i, row, headers, neonate_defaultFill)
            c3_08 = row[headers.index('c3_08')]
            ...
            if c1_15 == '1':
                ...
                if c3_12 != '0':
                    updatestr = 'Neonate :: Value at row %s col %s for variable c3_12 should be 0, setting to 0 and continuing' % (i + 2, headers.index('c3_12'))
                    warning_logger.warning(updatestr)
                    row[headers.index('c3_12')] = '0'
            elif c1_26 == '2' or c3_11 == '1':
                c3_12 = row[headers.index('c3_12')]
                if c3_12 != '1':
                    updatestr = 'Neonate :: Value at row %s col %s for variable c3_12 should be 1, setting to default and continuing' % (i + 2, headers.index('c3_12'))
                    warning_logger.warning(updatestr)
            ...
            #                     updatestr = 'Neonate :: WARNING: value at row %s col %s for variable g1_08 should be blank, setting to default and continuing' % (i+2, headers.index('g1_08'))
            #                     wx.PostEvent(self._notify_window, workerthread.ResultEvent(updatestr))
            #        warning_logger.warning(updatestr)
            ...
            if g5_04a < 12 or g5_04a == 999:
                ...
                if not (g5_05 is None or g5_05 == ''):
                    self.printWarning('g5_05', i, row, headers, neonate_defaultFill)
            if g5_04a < 5 or g5_04a == 999:
                g5_06a = row[headers.index('g5_06a')]
                if not (g5_06a is None or g5_06a == ''):
                    self.printWarning('g5_06a', i, row, headers, neonate_defaultFill)
            # not in electronic version
            # g5_06b = row[headers.index('g5_06b')]
            #                if not (g5_06b is None or g5_06b == ''):
            #                    updatestr = 'Neonate :: WARNING: value at row %s col %s for variable g5_06b should be blank, setting to default and continuing' % (i+2, headers.index('g5_06b'))
            #                    wx.PostEvent(self._notify_window, workerthread.ResultEvent(updatestr))
            #    warning_logger.warning(updatestr)
            ...
            if c5_04 != '1' or c5_05 != 1:
                ...
                if not (c5_07_1b is None or c5_07_1b == ''):
                    self.printWarning('c5_07_1b', i, row, headers, neonate_defaultFill)
        ...
        status_logger.debug('Neonate :: Analyzing free text')
        ...
        status_logger.debug('Neonate :: Processing duration variables')
        ...
        for row_i, row in enumerate(matrix):
            try:
                ...
                if (str(row[c5_07_1b]) == '0' or str(row[c5_07_1b]) == '9999' or str(row[c5_07_1b]) == '99' or str(
                        row[c5_07_1b]) == '999'):
                    row[c5_07_1b] = ''
                if (str(row[c5_07_2b]) == '0' or str(row[c5_07_2b]) == '9999' or str(row[c5_07_2b]) == '99' or str(
                        row[c5_07_2b]) == '999'):
                    row[c5_07_2b] = ''
                ...
                if str(row[c5_06_1d]) == '99' or row[c5_06_1d] == '' or row[c5_06_1d] is None:
                    row[c5_06_1d] = 1
                c5_06_1m = headers.index('c5_06_1m')
                if str(row[c5_06_1m]) == '99' or row[c5_06_1m] == '' or row[c5_06_1m] is None:
                    row[c5_06_1m] = 1
                c5_06_1y = headers.index('c5_06_1y')
                if str(row[c5_06_1y]) == '9999' or row[c5_06_1y] == '' or row[c5_06_1y] is None:
                    row[c5_06_1y] = 0

                c5_06_2d = headers.index('c5_06_2d')
                if str(row[c5_06_2d]) == '99' or row[c5_06_2d] == '' or row[c5_06_2d] is None:
                    row[c5_06_2d] = 1
                c5_06_2m = headers.index('c5_06_2m')
                if str(row[c5_06_2m]) == '99' or row[c5_06_2m] == '' or row[c5_06_2m] is None:
                    row[c5_06_2m] = 1
                c5_06_2y = headers.index('c5_06_2y')
                if str(row[c5_06_2y]) == '9999' or row[c5_06_2y] == '' or row[c5_06_2y] is None:
                    row[c5_06_2y] = 0
                ...
                if knownAge:
                    ...
                    if month >= 0 and month <= 60:
                        # only neonate
                        if row[headers.index('c5_07_2b')] == '' or row[headers.index('c5_07_2b')] is None or row[headers.index('c5_07_1b')] == '' or row[headers.index('c5_07_1b')] is None:
                            month = 0
                ...
                updatestr = 'Error in row: %s' % (row_i + 1)
